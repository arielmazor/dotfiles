...
local editor       = os.getenv("code") or "vim"
...
awful.spawn.with_shell("xrandr --output eDP-1 --mode 1920x1080 --pos 3440x180 --rotate normal --output HDMI-1 --primary --mode 3440x1440 --pos 0x0 --rotate normal --output DP-1 --off --output HDMI-2 --off")
